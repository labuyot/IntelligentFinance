...
public class AgregarDeuda extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final DBConnection connection = new DBConnection(AgregarDeuda.this);
        ...
        editTextFecha.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog mDatePicker=new DatePickerDialog(AgregarDeuda.this, new DatePickerDialog.OnDateSetListener() {
